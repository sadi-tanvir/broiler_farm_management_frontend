...
const ExpensesOverview = ({ setTotalExpneses }) => {
    ...
    setTotalExpneses(TotalExpenseAmount)

    return (
        <>
            <div className="col-lg-4 col-md-4 animate__animated animate__backInRight animate__slow">
