    ...
    return (
        <>
            <h6 className="text-sm mb-0 text-uppercase font-weight-bolder">
                <span className={`badge badge-sm bg-gradient-info animate__animated animate__pulse  animate__animated animate__heartBeat animate__infinite animate__slower`}>
