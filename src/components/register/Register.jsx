...
const signupImg = './assets/img/curved-images/curved14.jpg'
    ...
    return (
        <>
            <section className="min-vh-100 mb-8">
                <div className="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style={{ backgroundImage: `url(${signupImg})` }}>
                        ...
                        <div className="col-xl-4 col-lg-5 col-md-7 mx-auto">
                            <div className="card z-index-0">
                                ...
                                <div className="row px-xl-5 px-sm-4 px-3">
                                    <SignUpIcon
                                        divClass="col-3 ms-auto px-1"
                                        iconId="iconId"
                                        transform="translate(3.000000, 3.000000)"
                                        circleId="Oval"
                                        path1="M39.0974944,9.05587273 L32.5651312,9.05587273 C28.6886088,9.05587273 24.3768224,10.6862851 24.3768224,16.3054653 C24.395747,18.2634019 24.3768224,20.1385313 24.3768224,22.2488655 L19.8922122,22.2488655 L19.8922122,29.3852113 L24.5156022,29.3852113 L24.5156022,49.9295284 L33.0113092,49.9295284 L33.0113092,29.2496356 L38.6187742,29.2496356 L39.1261316,22.2288395 L32.8649196,22.2288395 C32.8649196,22.2288395 32.8789377,19.1056932 32.8649196,18.1987181 C32.8649196,15.9781412 35.1755132,16.1053059 35.3144932,16.1053059 C36.4140178,16.1053059 38.5518876,16.1085101 39.1006986,16.1053059 L39.1006986,9.05587273 L39.0974944,9.05587273 L39.0974944,9.05587273 Z"
                                        path1_id="Path"
                                        path1_fill="#FFFFFF"
                                    />
                                    <SignUpIcon
                                ...
                                <div className="card-body">
                                    <form onSubmit={handleRegister} roles="form text-left">
                                        <TextInputField
                                            divClass="mb-3"
                                            type="text"
                                            placeholder="Name"
                                    ...
                                    <p className="text-sm mt-3 mb-0">Already have an account?
                                        <Link to="/login" className="text-dark font-weight-bolder"> Sign in</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
